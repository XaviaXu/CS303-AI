...
if __name__ == '__main__':
    ...
    if model == 'LT':
        for i in range(core):
            result.append(pool.apply_async(LT.Loop, args=(map, rev_map, seeds, n, time_limit - 4)))
    else:
        for i in range(core):
            result.append(pool.apply_async(IC.Loop, args=(map, rev_map, seeds, n, time_limit - 4)))
